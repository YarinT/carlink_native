...
enum class CommandMapping(
    ...
    REQUEST_AUDIO_FOCUS(502),
    REQUEST_AUDIO_FOCUS_TRANSIENT(503),
    REQUEST_AUDIO_FOCUS_DUCK(504),
    RELEASE_AUDIO_FOCUS(505),
    REQUEST_NAVI_FOCUS(506),
    RELEASE_NAVI_FOCUS(507),
